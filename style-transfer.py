...
def build_loss(neural_net, optimizing_img, target_content_representation, target_style_representation, content_feature_maps_name, style_feature_maps_names, config):
	...
	target_content_representation = target_content_representation.squeeze(axis=0)
...
if __name__ == "__main__":
	...
	config['content_image_name'] = "me.jpg"
	...
	config['learning_rate'] = 1e1 # 1e1

	config['content_weight'] = 1e5 # 1e5
	config['style_weight'] = 1e5 # 1e5
